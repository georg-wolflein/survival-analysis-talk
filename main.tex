...
\begin{frame}{Survival function}
    ...
    The \textbf{survival function} $S(t)$ is the probability that an individual will survive until at least time $t$.
    \pause
...
\section[PH model]{Proportional hazards (PH) model}
