...
\begin{frame}{Proportional hazards assumption}
    ...
    \end{itemize}
\end{frame}
\note{The so-called \textbf{extended Cox model} allows the partial hazard to vary with time, and therefore no longer satisfies the proportional hazards assumption.}
...
\begin{frame}{Hazard ratios}
    The fraction used to express the proportional hazards assumption is actually the \textbf{hazard ratio} of individuals $i$ and $j$.
    \begin{equation*}
        HR =
